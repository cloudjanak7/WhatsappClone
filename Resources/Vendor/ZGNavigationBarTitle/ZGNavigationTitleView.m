...
- (void)drawContent:(CGRect)rect
{
    ...
    self.navigationBarSubtitleFontColor = [UIColor blackColor];
    ...
    if (self.navigationBarSubtitle.length) {
        ...
        [self.navigationBarTitle drawInRect:titleRect withFont:[UIFont systemFontOfSize:14]
        ...
        [self.navigationBarSubtitle drawInRect:subtitleRect withFont:[UIFont systemFontOfSize:12]
                                 lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentCenter];
    }
    else {
        CGRect titleRect = rect;
        ...
        [self.navigationBarTitleFontColor setFill];
        [self.navigationBarTitle drawInRect:titleRect withFont:[UIFont systemFontOfSize:16]
                              lineBreakMode:NSLineBreakByTruncatingTail alignment:NSTextAlignmentCenter];
    }
}
