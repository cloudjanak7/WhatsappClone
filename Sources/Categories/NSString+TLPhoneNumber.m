...
{
    NSCharacterSet *nums = [[NSCharacterSet characterSetWithCharactersInString:@"+0123456789"] invertedSet];
    return [[self componentsSeparatedByCharactersInSet:nums] componentsJoinedByString:@""];
}
