...
- (id)init
{
    if ((self = [super initWithBaseURL:[NSURL URLWithString:TL_BACKEND_BASE_URL]]) != nil) {
       ...
       withMethod:(NSString *)method
{
    ...
    for (NSString *key in [parameters allKeys]) {
        NSString *pair = [NSString stringWithFormat:kKeyValuePair, key, [parameters[key] URLEncodedString]];
    ...
    NSString *postLength = [NSString stringWithFormat:@"%d", [queryData length]];
