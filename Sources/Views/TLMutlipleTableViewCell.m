#import "TLMutlipleTableViewCell.h"
...
#define kCircleRadioUnselected      22.0
...
#define kColumnPosition             42.0
#define kMarkCell                   50.0
#define kImageRect                  CGRectMake(10.0, 8.0, 30.0, 30.0)

@implementation TLMutlipleTableViewCell
...
{    
    ...
    CGRect imageViewRect = CGRectMake(12, rect.size.height/2 - kCircleLeftMargin + 1, kMarkCell/2, kMarkCell/2);
...
- (void)layoutSubviews
{
    ...
    tmpFrame.origin.x = kMarkCell;
    tmpFrame.size.width = self.frame.size.width - kMarkCell;
    tmpFrame.origin.y = 8;
